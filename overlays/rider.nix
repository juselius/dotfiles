...
let
  ...
  vmoptsName =
    loName + super.lib.optionalString super.stdenv.hostPlatform.is64bit "64" + ".vmoptions";
  ...
  rider-latest = super.jetbrains.rider.overrideAttrs (attrs: rec {
    ...
    src = super.fetchurl {
      ...
      sha256 = "sha256-61cMsfnNeFGEvpZhOIlBfbcC7lYIKbJluRuGMaqDkLE=";
    };
